...
"resource": {
  ...
  "rules":[
    [["if",0,3],["unless",1,2],["add",2,3,0,113,130]],
    ...
    [["if",6,11],["add",10,11]],
    [["if",3,4],["add",14],["block",2,3,9,16,23,26,29,38,42,88,1,104,0,112,116,118,121,123,124,128,130,141,148]],
    ...
    [["if",3,17],["add",21]],
    [["if",3,19],["unless",18],["add",22,44,113]],
    [["if",20,21],["add",23]],
    [["if",16,22,23],["add",24,110]],
    ...
    [["if",16,27,28],["add",33]],
    [["if",16,29],["add",34]],
    [["if",16,30,31],["add",39,117]],
    [["if",3,32],["add",44,113]],
    [["if",3,33],["add",44]],
    [["if",3,34],["add",44,113],["block",123,124]],
    [["if",3,32,35],["add",44,113]],
    [["if",3,36],["add",44,113]],
    [["if",3,37],["add",44,113]],
    [["if",3,38],["add",44,113]],
    [["if",3,39],["add",44,113]],
    [["if",3,40],["add",44]],
    [["if",3],["unless",18],["add",50,53,54,57,59,61,64,66,68,69,70,72]],
    [["if",3,41],["add",51,52,55,56,58,60,62,63,65,67,71]],
    [["if",3,42],["add",80]],
    [["if",3,43],["add",86]],
    [["if",3,44],["add",88],["block",122,123,124,141,149]],
    [["if",3,45],["unless",46],["add",88]],
    [["if",47,48],["add",88]],
    [["if",3,50],["add",1]],
    [["if",3,52],["add",89,90]],
    [["if",53],["add",94]],
    [["if",53,54],["add",95,118],["block",112]],
    [["if",53,55],["add",100]],
    [["if",3,56],["add",101]],
    [["if",53,57,58],["add",101]],
    [["if",16,59],["add",102,142]],
    [["if",3,5],["add",109]],
    [["if",3,60],["add",113]],
    [["if",3,61],["add",113]],
    [["if",3,62],["add",113],["block",123,124]],
    [["if",3,63],["add",113]],
    [["if",3,64],["add",113]],
    [["if",3],["unless",65],["add",113]],
    [["if",3,66],["add",113]],
    [["if",3,67],["add",113]],
    [["if",3,68],["add",113]],
    [["if",3,69],["add",113]],
    ...
    [["if",3,72],["unless",73,74],["add",113]],
    [["if",3,75],["add",113]],
    [["if",8,76],["add",114,140]],
    [["if",77,78,79,80],["add",122,132]],
    [["if",0,3],["unless",1,25],["add",123,124,148]],
    [["if",3,85],["add",129]],
    [["if",16,86],["add",144]],
    [["if",16,87],["add",145]],
    [["if",16,88],["add",146]],
    [["if",78,80,89],["add",149]],
    [["if",3,25],["block",29,88,1]],
    [["if",3,49],["block",88]],
    [["if",3,51],["block",1]],
    [["if",3,81],["block",122,123,124,141,149]],
    [["if",3,82],["block",122,123,124,141,149]],
    [["if",3,83],["block",122,123,124,141,149]],
    [["if",3,84],["block",123,124]]]
},
"runtime":[
[],[]
]
